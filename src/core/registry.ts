import { each, isFn, isPlainObj } from '../shared';
...
const DESIGNER_GlobalRegistry = {
  setComponentDesignerProps: (componentName: string, props: IDesignerControllerProps) => {
  ...
  getComponentDesignerProps: (componentName: string) => {
    // console.log('getComponentDesignerProps',DESIGNER_PROPS_MAP[componentName]);
