import { isArr, isWindow } from '../utils/checker';
...
export interface IEventProps<T = EventEngine> {
...
/**
 * 事件引擎，将事件绑定到容器，并使用指定的驱动器去驱动事件
 * 将驱动器与容器绑定，让容器具有驱动某类事件的能力
 */
export class EventEngine extends Subscrible<ICustomEvent<any>> {
